...
{
    public class BrandPageContentConfiguration : IEntityTypeConfiguration<BrandPageContent>
    {
        public void Configure(EntityTypeBuilder<BrandPageContent> builder)
        {
            builder.ToTable("brand_page_contents", "content");
